...
(function(a) {
    a.easytabs = function(j, e) {
        ...
        f.toggleTabCollapse = function(x, y, z, A) {
            ...
            if (u(q, "easytabs:before", [x, y, r])) {
                ...
                if (x.hasClass(r.collapsedClass)) {
                    ...
                    y.removeClass(r.panelActiveClass)[v.collapse](v.speed, r.transitionCollapseEasing,
                        function() {
                            q.trigger("easytabs:midTransition", [x, y, r]);
                            if (typeof A == "function") {
                                A()
        ...
        var w = function() {
            f.tabs.children("a").bind(r.bind_str,
                function(x) {
                    r.cycle = false;
                    d = false;
                    f.selectTab(a(this));
        ...
        var o = function(z, D, E, H) {
            ...
            if (u(q, "easytabs:before", [z, D, r])) {
                ...
                G = function() {
                    ...
                    D[v.show](v.speed, r.transitionInEasing,
                        function() {
                            y.css({
                                height: "",
                                "min-height": ""
